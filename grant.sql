...
GRANT execute ON FUNCTION pils4.in_kommun TO 'pils4'@'localhost';
GRANT execute ON FUNCTION pils4.is_member TO 'pils4'@'localhost';
GRANT execute ON FUNCTION pils4.yearly_attendance TO 'pils4'@'localhost';
